...
func (e ExecutableData) MarshalJSON() ([]byte, error) {
	...
	enc.GasRevenues = e.GasRevenues
	enc.AddVoters = e.AddVoters
	enc.RemoveVoters = e.RemoveVoters
	enc.BridgeWithdrawals = e.BridgeWithdrawals
	enc.ReplaceByFees = e.ReplaceByFees
	enc.Cancel1s = e.Cancel1s
...
func (e *ExecutableData) UnmarshalJSON(input []byte) error {
	...
	if dec.GasRevenues != nil {
		e.GasRevenues = *dec.GasRevenues
	}
	if dec.AddVoters != nil {
		e.AddVoters = *dec.AddVoters
	}
	if dec.RemoveVoters != nil {
		e.RemoveVoters = *dec.RemoveVoters
	}
	if dec.BridgeWithdrawals != nil {
		e.BridgeWithdrawals = *dec.BridgeWithdrawals
	}
	if dec.ReplaceByFees != nil {
		e.ReplaceByFees = *dec.ReplaceByFees
	}
	if dec.Cancel1s != nil {
		e.Cancel1s = *dec.Cancel1s
	}
	return nil
}
