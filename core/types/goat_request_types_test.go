...
func TestRequest_JSONCodec(t *testing.T) {
	tests := []struct {
		...
		{
			name:   "GasRevenue",
			fields: NewRequest(&GasRevenue{Amount: big.NewInt(1)}),
		},
		{
			name:   "AddVoter",
			fields: NewRequest(&AddVoter{Voter: common.HexToAddress("0xb32146eb86ab10dcd2a2f1cf9a581d0de8e4308a"), Pubkey: common.HexToHash("5f36d08e6450dd7a5404bd3ea651c731b15d75607c7ca91cab06ee93129ec514")}),
		},
		{
			name:   "RemoveVoter",
			fields: NewRequest(&RemoveVoter{Voter: common.HexToAddress("3d133e977cb1b73c1dbc3180cdec35f940ffe058")}),
		},
		{
		...
		{
			name:   "ReplaceByFee",
			fields: NewRequest(&ReplaceByFee{MaxTxPrice: 1}),
		},
		{
			name:   "Cancel1",
			fields: NewRequest(&Cancel1{}),
		},
	}
